...
class UserController extends Controller
{
    ...
    return redirect('/index')->with('success', 'Competency Elements and Examinations created successfully.');
    }
    ...
    // Redirect after successfully creating the competency elements and examinations
    return redirect('/home')->with('success', 'Competency Elements and Examinations created successfully.');
    }
