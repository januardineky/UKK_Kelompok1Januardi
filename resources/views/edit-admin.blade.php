         ...
         <div class="inner_container">
            ...
            <div id="content">
               ...
               <div class="midde_cont">
                  ...
                  <form action="/home/updateadmin/{{ $admin->id }}" method="post">
                    @csrf
                    <fieldset>
                        <legend><span class="number">1</span> General</legend>

                        <label for="name">Name:</label>
                        <input type="text" id="name" name="full_name" value="{{ old('full_name', $admin->full_name) }}" required>
                        ...
                        <input type="text" id="phone_number" name="phone_number" value="{{ old('phone_number', $admin->phone_number) }}" required>
                    </fieldset>

                    <input type="submit" class="btn btn-primary" style="width: 100%" value="Update admin">
                </form>
               </div>
               <!-- end dashboard inner -->
            </div>
