         ...
         <div class="inner_container">
            ...
            <div id="content">
               ...
               <div class="midde_cont">
                  ...
                  <form action="/home/updatemajor/{{ $major->id }}" method="post" style="margin-top: 230px">
                    @csrf
                    <fieldset>
                        <label for="major_name">Name:</label>
                        <input type="text" id="major_name" name="major_name" value="{{ old('major_name', $major->major_name) }}">

                        <label for="description">Description:</label>
                        <textarea id="description" name="description">{{ old('description', $major->description) }}</textarea>
