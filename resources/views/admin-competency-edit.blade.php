         ...
         <div class="inner_container">
            ...
            <div id="content">
               ...
               <div class="midde_cont">
                  ...
                  <form action="/home/updatecompetency/{{ $competencyStandard->id }}" method="post">
                    @csrf
                    <fieldset>
                        <label for="kode">Unit Kode:</label>
                        <input type="text" id="kode" name="unit_code" value="{{ old('unit_code', $competencyStandard->unit_code) }}">

                        <label for="title">Unit Title:</label>
                        <input type="text" id="title" name="unit_title" value="{{ old('unit_title', $competencyStandard->unit_title) }}">

                        <label for="description">Deskripsi:</label>
                        <textarea id="description" name="unit_description">{{ old('unit_description', $competencyStandard->unit_description) }}</textarea>
                    </fieldset>
                    ...
                    <fieldset>
                        ...
                        <select id="major" name="major_id" required>
                            ...
                            @foreach ($majors as $maj)
                                <option value="{{ $maj->id }}" {{ $maj->id == $competencyStandard->major_id ? 'selected' : '' }}>
                                    {{ $maj->major_name }}
                                </option>
                            @endforeach
                        </select>
                        ...
                        <select id="assessor" name="assessor_id" required>
                            <option value=""></option>
                            @foreach ($assessors as $assess)
                                <option value="{{ $assess->id }}" {{ $assess->id == $competencyStandard->assessor_id ? 'selected' : '' }}>
                                    {{ $assess->user->full_name }}
                                </option>
                        @endforeach
                        </select>
                    </fieldset>
