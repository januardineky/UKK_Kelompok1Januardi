    ...
    @include('sweetalert::alert')
         ...
         <div class="inner_container">
            ...
            <div id="content">
               ...
               <div class="midde_cont">
                  ...
                  <form action="/index/inputelement" method="post" id="criteriaForm">
                    @csrf
                    <fieldset>
                        <div id="criteriaContainer">
                            <div class="criteriaRow">
                                <label for="criteria">Kriteria :</label>
                                <textarea name="criteria[]" required></textarea>
                                ...
                                <div class="button-container">
                                    <button type="button" class="removeButton btn btn-danger btn-sm">Remove</button>
                                </div>
                            </div>
                        </div>

                        <div class="button-container">
                            <button type="button" id="addButton" class="btn btn-secondary btn-sm">Add More</button>
                        </div>
                    </fieldset>
      ...
      <script>
        document.getElementById('addButton').addEventListener('click', function() {
            ...
            newRow.classList.add('criteriaRow');
            newRow.innerHTML = `
                <label for="criteria">Kriteria :</label>
                <textarea name="criteria[]" required></textarea>
        ...
        document.getElementById('criteriaContainer').addEventListener('click', function(e) {
